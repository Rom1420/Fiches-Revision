...
- Objectif : maîtriser conception, prototypage et évaluation d’IHM utilisables.
...
> 💡 Mesurer l’utilisabilité = performances (succès, temps, erreurs) + ressenti (satisfaction, stress) + conformité aux standards ergonomiques.
...
> À retenir : l’UCD est une spirale ; garder traces des décisions pour alimenter la rationale (séance 5).
...
> 💡 Valider ses hypothèses auprès des équipes terrain (support, hotline) et éviter stéréotypes figés.
...
3. Minimiser charge cognitive (reconnaissance > rappel).
4. Cohérence.
