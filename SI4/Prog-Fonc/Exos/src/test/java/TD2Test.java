...
public class TD2Test {
    ...
    public void testCountWithMultipleElements() {
        Lst<Integer> multipleElementsList = new Lst<>(1, new Lst<>(2, new Lst<>(3, new Lst<>(4, null))));
        int count = countTerminale(i -> i % 2 == 0, multipleElementsList);
    ...
    public void testReduceWithAllElements2() {
        ...
        int product = reduceTerminale((i, j) -> i * j, multipleElementsList, 1);
    ...
    public void testReduceSizes() {
        ...
        int product = reduceTerminale((s, x) -> s.length() + x, multipleElementsList, 0);
    ...
    public void testSumLength() {
        ...
        int resultLowers = sumLengthLowers(multipleElementsList);
        int result = sumLength(multipleElementsList);
        assertEquals(6, resultLowers);
